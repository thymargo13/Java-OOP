...
public class DisplayAll extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ArrayList<ProductBean> allproduct = null;
            ArrayList<OtherProductBean> allotherproduct = null;
            allproduct = product_db.showAllProduct();
            allotherproduct = o_db.showAllOtherProduct();
            //out.println(action);
            request.setAttribute("allproduct", allproduct);
            request.setAttribute("allotherproduct", allotherproduct);
            RequestDispatcher rd = this.getServletContext().getRequestDispatcher("/search.jsp");
