 ...
 * @author Daniel
 */
@WebServlet(name = "ShowMyinfo", urlPatterns = {"/ShowMyinfo"})
public class ShowMyinfo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ShowMyinfo</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Error, invalid input in url</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
