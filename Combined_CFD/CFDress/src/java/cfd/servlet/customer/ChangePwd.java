...
public class ChangePwd extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("Confirm Pwd: " + newPwd2);

        if (newPwd.equals(newPwd2)) {
            db.changePwd(id, newPwd);
            isSuccess = "true";
        }

        RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/showCustomerInfo.jsp");
