...
<nav class="navbar navbar-inverse">
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav">
            <li><a href="#">Home</a></li>
            <!-- <li><a href="verification.jsp">Activate Customer</a></li> -->
            <li><a href="CMS/custList.jsp">Customers</a></li>
            ...
            <li><a href="/CFDress/handleStaff?action=edit&id=S1">StaffInfo</a></li>
        </ul>
